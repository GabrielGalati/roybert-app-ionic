...
@Component({
  selector: 'app-ejerciciof3',
  templateUrl: './ejerciciof3.page.html',
  styleUrls: ['./ejerciciof3.page.scss'],
})
export class Ejerciciof3Page{
...
async mostrarMensajeDeGanar() {
    ...
    this.router.navigate(['/ejerciciof4']);
    this.inicializar();
    await alert.present();
  }
}
