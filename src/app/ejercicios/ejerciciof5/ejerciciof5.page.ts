...
@Component({
  selector: 'app-ejerciciof5',
  templateUrl: './ejerciciof5.page.html',
  styleUrls: ['./ejerciciof5.page.scss'],
})
export class Ejerciciof5Page{
...
async mostrarMensajeDeGanar() {
    ...
    this.router.navigate(['/ejerciciof6']);
    this.inicializar();
    await alert.present();
  }
}
