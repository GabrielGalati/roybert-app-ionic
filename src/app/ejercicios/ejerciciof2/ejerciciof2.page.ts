...
@Component({
  selector: 'app-ejerciciof2',
  templateUrl: './ejerciciof2.page.html',
  styleUrls: ['./ejerciciof2.page.scss'],
})
export class Ejerciciof2Page{
...
async mostrarMensajeDeGanar() {
    ...
    this.router.navigate(['/ejerciciof3']);
    this.inicializar();
    await alert.present();
  }
}
